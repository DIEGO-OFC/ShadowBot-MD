let handler = async (m, {conn, participants, groupMetadata}) => {
  const pp = (await conn.profilePictureUrl(m.chat, "image").catch((_) => null)) || "./galeria/avatar_contact.png";
  const {
    isBanned,
    welcome,
    detect,
...
handler.help = ["prueba338"];
handler.tags = ["prueba338"];
handler.command = /^(prueba338)$/i;
handler.group = true;
