import {youtubedl, youtubedlv2} from '@bochilteam/scraper'; 
 ...
 const handler = async (m, {conn, args, usedPrefix, command}) => { 
   ...
   const { key } = await conn.sendMessage(m.chat, {image: fs.readFileSync("./galeria/menudorrat5.png"), caption: info}, {quoted: m});
   try { 
   ...
   try { 
     ...
     try { 
       ...
       await conn.sendMessage(m.chat, {video: {url: mediaa.result}, fileName: `error.mp4`, caption: `_Zirax-Bot-MD`, thumbnail: mediaa.thumb, mimetype: 'video/mp4'}, {quoted: m}); 
       await conn.sendMessage(m.chat, {text: '*[ ✔ ] Video descargado exitosamente.*', edit: key}, {quoted: m}); 
       enviando = false 
     } catch { 
       try { 
