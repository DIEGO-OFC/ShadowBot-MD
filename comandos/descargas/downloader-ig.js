...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  ...
  if (!args[0]) throw `ingresa el comando con el enlace _${usedPrefix + command} https://www.instagram.com/reel/Cc0NuYBg8CR/?utm_source=ig_web_copy_link_`;
  m.reply(global.wait);
  try {
