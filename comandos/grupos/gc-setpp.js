import {webp2png} from "../../../home/lib/webp2mp4.js";
...
let handler = async (m, {conn, args}) => {
  ...
  if (/image/.test(mime)) {
    ...
    await conn.updateProfilePicture(m.chat, {url}).then((_) => m.reply("🖼️ *_Imagen actualizada con éxito._*"));
  } else if (args[0] && args[0].match(URL_REGEX)) {
    await conn.updateProfilePicture(m.chat, {url: args[0]}).then((_) => m.reply("🖼️ *_Imagen actualizada con éxito._*"));
